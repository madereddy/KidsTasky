  ...
  return (
    <div className="bg-white shadow-sm border border-ui-soft p-6 rounded-3xl mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        {rewards.map(r => (
            <div key={r.id} className="bg-white shadow-sm p-4 rounded-xl flex justify-between items-center border border-ui">
                <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
        ...
        <div className="flex items-center gap-2">
          <span className="text-ui-muted font-bold">$</span>
          <input
            type="number"
            min={0}
            step={0.25}
        ...
        <button onClick={addReward} className="btn-immersive-primary bg-yellow-600 hover:bg-yellow-500 text-ui-primary font-bold">Add Reward</button>
      </div>
    </div>
  );
}
