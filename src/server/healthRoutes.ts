...
healthRouter.post('/client-logs', (req, res) => {
...
healthRouter.get('/health/memory', (req, res) => {
...
healthRouter.get('/health/build', (req, res) => {
  res.json({
    status: 'ok',
    build: getBuildInfo(),
  });
...
healthRouter.get('/health/requests', (req, res) => {
...
healthRouter.get('/health/cache', (req, res) => {
  res.json({
    status: 'ok',
...
healthRouter.get('/health/worker', (req, res) => {
  res.json({
    status: 'ok',
...
healthRouter.get('/health/db', (req, res) => {
  const startedAt = Date.now();
...
healthRouter.get('/health/perf', (req, res) => {
...
healthRouter.get('/health/deps', async (req, res) => {
